  ...
  return (
    <>
      <div className='w-full h-30 px-2'>
        <img src={props.src} alt='Entertainment Cards' className='w-full h-full rounded-lg' />
      </div>
    </>)
}
...
const EntertainmentCardSlider = () => {
  ...
  return (
    ...
    <Slider {...settings}>
      {EntertainmentImages.map((images, index) => (
        <EntertainmentCard src={images} key={index} />
      ))}
    </Slider>
